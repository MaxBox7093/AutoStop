...
{
    internal class RegistrationCarAPI : ApiService
    {
        public async Task<bool> RegisterCar(Car car)
        {
            try
            {
                ...
                HttpResponseMessage response = await _httpClient.PostAsync("car", content);
